...
It is only meant for local development, and the setup for it can be found inside the [/dev](https://github.com/ansible/ansible-rhdh-plugins/tree/main/plugins/self-service/dev) directory.
